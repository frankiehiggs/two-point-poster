...
\definecolorstyle{Default}{
    ...
    % Bath stone: d5d3b9
		% Slate: 50565e
		% Grey: 484542
		% Bath Department of Mathematical Sciences: 62bb46
    \definecolor{stone}{HTML}{d5d3b9}
    \definecolor{slate}{HTML}{50565e}
    \definecolor{grey}{HTML}{484542}
    \definecolor{research}{HTML}{3b93a6}
    \definecolor{colorOne}{HTML}{d5d3b9} % Background
    \definecolor{colorTwo}{HTML}{50565e} % Box outlines
    \definecolor{colorThree}{HTML}{000000}%FCF0AD}
}{
     % Background Colors

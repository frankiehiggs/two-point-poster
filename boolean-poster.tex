...
\title{Boundary effects in continuum percolation}
...
\block{}{
\centering
\includegraphics[width=0.20565\textwidth]{images/tetra}\\
Tetrahedron, with $\mathcal{X}_n$ in blue,
and the furthest point from $\mathcal{X}_n$ marked in red.\vspace{20pt}
\includegraphics[width=0.20565\textwidth]{images/icosa}\\
Icosahedron
}
